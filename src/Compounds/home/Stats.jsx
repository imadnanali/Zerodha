        ...
        <div className='container mt-5'>
            <div className='row p-3'>
                <div className='col-6'>
                    ...
                    <p className='mb-5 text-muted'>That's why 1.6+ crore customers trust Zerodha with ~ ₹6 lakh crores of equity investments and contribute to 15% of daily retail exchange volumes in India.</p>
