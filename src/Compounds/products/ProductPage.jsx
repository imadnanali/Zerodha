...
const ProductPage = () => {
  return (
    <div>
      ...
      <Leftimage
        imgURL={`${import.meta.env.BASE_URL}media/images/kite.png`} 
        productName="Kite"
        ...
        tryDemo=''
        learnMore=''
        googlePlay={`${import.meta.env.BASE_URL}media/images/googlePlayBadge.svg`} 
        appStore={`${import.meta.env.BASE_URL}media/images/appstoreBadge.svg`} 
      />
      <RightImage
        productName='Console'
        ...
        learnMore=''
        imgURL={`${import.meta.env.BASE_URL}media/images/console.png`} 
      />

      <Leftimage
        imgURL={`${import.meta.env.BASE_URL}media/images/coin.png`} 
        productName="Coin"
      ...
      <RightImage
        ...
        learnMore=''
        imgURL={`${import.meta.env.BASE_URL}media/images/kiteconnect.png`} 
      />


      <Leftimage
        imgURL={`${import.meta.env.BASE_URL}media/images/varsity.png`} 
      ...
      <div className='text-center mb-4'>
        ...
        <div className="row mt-5 pt-5">
          <div className='col-4 '>
            <img src={`${import.meta.env.BASE_URL}media/images/smallcaseLogo.png`}  />
            <p className='text-muted'>Thematic investing platform</p>
          </div>
          <div className='col-4 '>
            <img style={{ width: '25%' }} src= {`${import.meta.env.BASE_URL}media/images/streakLogo.png`} />
            <p className='text-muted'>Systematic trading platform</p>
          </div>
          <div className='col-4 '>
            <img style={{ width: '40%' }} src={`${import.meta.env.BASE_URL}media/images/sensibullLogo.svg`}  />
        ...
        <div className="row mt-5">
          <div className='col-4 '>
            <img style={{ width: '45%' }} src={`${import.meta.env.BASE_URL}media/images/zerodhaFundhouse.png`}  />
            <p className='text-muted'>Thematic investing platform</p>
          </div>
          <div className='col-4 '>
            <img src={`${import.meta.env.BASE_URL}media/images/goldenpiLogo.png`} />
            <p className='text-muted'>Thematic investing platform</p>
          </div>
          <div className='col-4 '>
            <img style={{ width: '40%' }} src={`${import.meta.env.BASE_URL}media/images/dittoLogo.png`}  />
            <p className='text-muted'>Thematic investing platform</p>
          </div>
        </div>
